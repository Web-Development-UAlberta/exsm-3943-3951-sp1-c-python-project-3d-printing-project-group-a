...
describe('Register Page', () => {
  it('renders the register page', () => {
    ...
    expect(screen.getByPlaceholderText('e.g. Robel Measho')).toBeInTheDocument()
    expect(screen.getByPlaceholderText('e.g. R@email.com')).toBeInTheDocument()
    expect(screen.getByPlaceholderText('e.g. 780-555-0101')).toBeInTheDocument()
